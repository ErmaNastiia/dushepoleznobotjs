...
bot.command('start', async ctx => {
  await ctx.reply(
    'Привет! я бот для аренды Простраства. Мы открыты с 9 до 22 и работаем без выходных. Подробнее <a href="https://dushepolezno.ru/prostranstvo">тут</a>. Перед началом бронирования обязательно посмотрите свободные слоты в <a href="https://dushepolezno.ru/prostranstvo-zapis">расписании</a>. Если все понятно вводите /book и мы начнем процесс бронирования. Подробнее о кабинетах введите /info',
