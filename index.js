...
bot.command('start', async ctx => {
  await ctx.reply(
    'Привет! я бот для аренды Простраства. Мы открыты с 9 до 22 и работаем без выходных. Подробнее узнай тут: <a href="https://dushepolezno.ru/prostranstvo">ссылка</a>. Перед началом бронирования посмотри актуальное расписание на нашем сайте <a href="https://dushepolezno.ru/prostranstvo-zapis">ссылка</a>. Если все понятно вводи /book и мы начнем процесс бронирования. Подробнее о кабинетах введи /info',
